const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RealisticTree.glsl-DvWYvn2U.js","assets/index-CRzb-W8M.js","assets/index-QvPG3F6p.css","assets/HUDMaterial.glsl-wI7CWnW_.js","assets/meshVertexSpaceUtils-7U_X-9Pj.js","assets/vec32-BBWd0QdN.js","assets/MeshLocalVertexSpace-B363wPLk.js","assets/projectVectorToVector-Co-X4GUu.js","assets/projectPointToVector-DWcPrZHr.js","assets/hydratedFeatures-BXmqigQY.js","assets/vec3f32-WCVSSNPR.js","assets/OutputColorHighlightOID.glsl-8Q9awpX5.js","assets/Texture-E_k1AGuI.js","assets/Indices-BID3Lu2E.js","assets/BufferView-BzS-JzF2.js","assets/vec2f64-Cgb6qxNH.js","assets/triangle-BaShAMrQ.js","assets/sphere-D8iEV68S.js","assets/vectorStacks-SrJv2Bzq.js","assets/quatf64-aQ5IuZRd.js","assets/lineSegment-Do4GA3JG.js","assets/renderState-CKc66y4x.js","assets/glsl-B5bJgrnA.js","assets/frustum-BFtAANay.js","assets/plane-BdZOnIHI.js","assets/orientedBoundingBox-CqYhHA_c.js","assets/quat-2QXa723r.js","assets/spatialReferenceEllipsoidUtils-CVL0VuUQ.js","assets/computeTranslationToOriginAndRotation-CQxa17z8.js","assets/InterleavedLayout-kvcL0QC7.js","assets/types-BKo2foNY.js","assets/ShaderBuilder-_7fix7uF.js"])))=>i.map(i=>d[i]);
import{o as L,H as et,s as At,A as Dt,c as be,r as Gt,g as Ge,P as jt,N as Bt}from"./vec32-BBWd0QdN.js";import{ik as ze,ad as x,bS as k,cV as $e,jE as tt,S as Ht,e1 as Wt,i2 as kt,hV as Ut,pd as Yt,kq as qt,tZ as at,Q as c,a2 as H,R as ot,t_ as Zt,t$ as Xt,k2 as Q,j_ as Fe,i1 as je,hT as Jt,u0 as U,a8 as he,jf as ne,fy as re,U as Kt,fh as Qt,ka as ea,an as ta,bU as z,dF as aa,iy as oa,nK as ra,bV as ia}from"./index-CRzb-W8M.js";import{a6 as E,i as me,d as pe,a7 as I,a as rt,a8 as fe,a9 as it,aa as nt,ab as na,ac as W,ad as sa,ae as la,af as ca,f as da,ag as J,r as O,a2 as ae,D as A,E as D,ah as G,G as K,b as y,I as j,ai as ua,H as ha,aj as ma,ak as st,q as se,al as lt,o as ct,am as dt,g as pa,j as Ne,k as ve,s as ut,an as fa,ao as va,u as ga,v as Be,ap as xa,aq as _,ar as Oe,as as ba,at as wa,c as ee,au as ya,W as oe,av as Ma,M as Ta,aw as ht,ax as le,F as mt,L as pt,K as ft,ay as vt,J as gt,Q as _a,U as Sa,N as Ca,O as za,P as $a,R as Fa,V as Na,X as Oa,T as Ia,Y as Va,x as m,A as La,az as we,aA as ye,a1 as Ea,aB as Ra,B as Pa,aC as Aa,a3 as Da,aD as Ga}from"./OutputColorHighlightOID.glsl-8Q9awpX5.js";import{t as Ce,Q as Ie}from"./InterleavedLayout-kvcL0QC7.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as S,T as xt,g as ce,I as He}from"./BufferView-BzS-JzF2.js";import{r as ja}from"./VertexBuffer-DHqCVAiB.js";import{g as Ba}from"./plane-BdZOnIHI.js";import{a as Ha,n as bt}from"./vec2f64-Cgb6qxNH.js";import{s as ge}from"./ShaderBuilder-_7fix7uF.js";import{T as Ve,d as Le,_ as Wa}from"./renderState-CKc66y4x.js";import{h as ka,A as Ua}from"./Texture-E_k1AGuI.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return color;
}`)}const Ue=k();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:o,instanced:r,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new na("model",l=>l.modelTransformation??je)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Jt(Ue,l.modelTransformation??je),Ue)))),r&&o&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;o&&(n.include(Ya,e),n.uniforms.add(new W("viewOriginHi",l=>sa(L(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new W("viewOriginLo",l=>la(L(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
    ...
    }`)}const ie=x();function St(a,e){a.varyings.add("colorMixMode","int"),a.varyings.add("opacityMixMode","int"),a.vertex.uniforms.add(new da("symbolColorMixMode",t=>J[t.colorMixMode])),e.hasSymbolColors?(a.vertex.include(fe),a.vertex.include(it),a.vertex.include(nt),a.attributes.add("symbolColor","vec4"),a.vertex.code.add(i`
...
forwardTextureCoordinates();`),a.include(B,e),o.main.add(i`
        ...
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 4:case 5:case 6:case 7:case 10:A(t,e),a.include(D),a.include(G,e),a.include(K,e),a.include(co,e),o.include(j,e),a.include(ha,e),ma(a),r.add("depth","float",{invariant:!0}),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),o.include(j,e),a.include(B,e),a.include(ua,e),o.main.add(i`
        discardBySlice(vpos);
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
}`),s&&d!==0&&(a.include(st,e),t.uniforms.add(n===1?new y("normalTexture",u=>u.textureNormal):new se("normalTexture",u=>u.textureNormal)),l&&(t.uniforms.add(new lt("scale",u=>u.scale??Ha)),t.uniforms.add(new I("normalTextureTransformMatrix",u=>u.normalTextureTransformMatrix??U))),t.code.add(i`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
}`),a.outputs.add("fragOcclusion","float"),e.uniforms.add(new y("normalMap",t=>t.normalTexture),new y("depthMap",t=>t.depthTexture),new O("projScale",t=>t.projScale),new y("rnm",t=>t.noiseTexture),new lt("rnmScale",(t,o)=>ne(Xe,o.camera.fullWidth/t.noiseTexture.descriptor.width,o.camera.fullHeight/t.noiseTexture.descriptor.height)),new O("intensity",t=>t.intensity),new va("screenSize",t=>ne(Xe,t.camera.fullWidth,t.camera.fullHeight))).main.add(i`
...
}`))}const Ke=x(),$=tt();function ue(a){a.uniforms.add(new W("mainLightDirection",e=>e.lighting.mainLight.direction))}function te(a){a.uniforms.add(new W("mainLightIntensity",e=>e.lighting.mainLight.intensity))}function So(a){ue(a.fragment),te(a.fragment),a.fragment.code.add(i`vec3 applyShading(vec3 shadingNormal, float shadow) {
...
float occlusion;`),r&&o.uniforms.add(l===1?new y("texMetallicRoughness",u=>u.textureMetallicRoughness):new se("texMetallicRoughness",u=>u.textureMetallicRoughness)),d&&o.uniforms.add(l===1?new y("texOcclusion",u=>u.textureOcclusion):new se("texOcclusion",u=>u.textureOcclusion)),o.uniforms.add(l===1?new ee("mrrFactors",u=>u.mrrFactors):new ya("mrrFactors",u=>u.mrrFactors)),o.code.add(i`
...
}`)):a.vertex.code.add(i`void forwardMetallicRoughnessUV(){}`)}function Vt(a){a.include(Ta),a.code.add(i`
