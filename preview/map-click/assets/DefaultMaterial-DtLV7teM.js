const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RealisticTree.glsl-BbEIOH4r.js","assets/index-D2B_S-qX.js","assets/index-m__2acZG.css","assets/HUDMaterial.glsl-DgTImyt8.js","assets/meshVertexSpaceUtils-DjwK61Lu.js","assets/MeshLocalVertexSpace-C0mp40WZ.js","assets/projectVectorToVector-B7-YGGpr.js","assets/projectPointToVector-CILrbPod.js","assets/hydratedFeatures-D4zR6Ke0.js","assets/vec3f32-WCVSSNPR.js","assets/OutputColorHighlightOID.glsl-BWwMPJ9V.js","assets/Indices-DDEPU_dG.js","assets/BufferView-BuBzPYfg.js","assets/triangle-C8FbwWYB.js","assets/sphere-P_h4xPVB.js","assets/vectorStacks-BCbPlF5W.js","assets/quatf64-aQ5IuZRd.js","assets/lineSegment-CdbVZHPn.js","assets/renderState-CKc66y4x.js","assets/glsl-B5bJgrnA.js","assets/frustum-9iiXSFKZ.js","assets/plane-DszPT9e-.js","assets/orientedBoundingBox-Bn7akRdk.js","assets/quat-DSaKqn92.js","assets/spatialReferenceEllipsoidUtils-DJUN7vI0.js","assets/computeTranslationToOriginAndRotation-JI2CBHaY.js","assets/InterleavedLayout-EMpBbA7I.js","assets/types-BKo2foNY.js","assets/ShaderBuilder-CAT-n36j.js"])))=>i.map(i=>d[i]);
import{ji as ze,b3 as x,bz as k,dC as $e,jZ as et,M as At,fA as Dt,j1 as Gt,gf as L,iR as jt,q6 as Bt,kN as Ht,vL as tt,T as c,U as H,V as at,vM as Wt,vN as kt,k_ as Q,bd as ot,kT as Fe,i$ as Ge,iP as Ut,mM as Yt,vO as U,b8 as he,b2 as rt,kO as ne,dg as re,eE as qt,eG as Zt,eS as Xt,cD as Jt,kg as Kt,K as Qt,bA as z,fg as ea,jo as ta,p6 as aa,bX as oa,bq as ra,bp as be,bV as ia,bn as je,bo as na,iS as sa,bE as la}from"./index-D2B_S-qX.js";import{a6 as E,i as me,d as pe,a7 as I,a as it,a8 as fe,a9 as nt,aa as st,ab as ca,ac as W,ad as da,ae as ua,af as ha,f as ma,ag as J,r as O,a2 as ae,D as A,E as D,ah as G,G as K,b as y,I as j,ai as pa,H as fa,aj as va,ak as lt,q as se,al as ct,o as dt,am as ut,g as ga,j as Ne,k as ve,s as ht,an as xa,ao as ba,u as wa,v as Be,ap as ya,aq as _,ar as Oe,as as Ma,at as Ta,c as ee,au as _a,W as oe,av as Sa,M as Ca,aw as mt,ax as le,F as pt,L as ft,K as vt,ay as gt,J as xt,Q as za,U as $a,N as Fa,O as Na,P as Oa,R as Ia,V as Va,X as La,T as Ea,Y as Ra,x as m,A as Pa,az as we,aA as ye,a1 as Aa,aB as Da,B as Ga,aC as ja,a3 as Ba,aD as Ha}from"./OutputColorHighlightOID.glsl-BWwMPJ9V.js";import{t as Ce,Q as Ie}from"./InterleavedLayout-EMpBbA7I.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-BuBzPYfg.js";import{r as Wa}from"./VertexBuffer-BngOwMhw.js";import{g as ka}from"./plane-DszPT9e-.js";import{s as ge}from"./ShaderBuilder-CAT-n36j.js";import{T as Ve,d as Le,_ as Ua}from"./renderState-CKc66y4x.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return color;
}`)}const Ue=k();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:o,instanced:r,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new ca("model",l=>l.modelTransformation??Ge)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Ut(Ue,l.modelTransformation??Ge),Ue)))),r&&o&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;o&&(n.include(Ya,e),n.uniforms.add(new W("viewOriginHi",l=>da(L(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new W("viewOriginLo",l=>ua(L(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
...
}`)):a.vertex.code.add(i`void forwardMetallicRoughnessUV(){}`)}function Vt(a){a.include(Ca),a.code.add(i`
