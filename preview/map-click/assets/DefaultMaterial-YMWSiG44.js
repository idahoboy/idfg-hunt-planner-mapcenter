const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RealisticTree.glsl-BfEamyb1.js","assets/index-Bc5nTF8z.js","assets/index-CoCyaKlK.css","assets/HUDMaterial.glsl-BTzQ0z8m.js","assets/vec3f32-WCVSSNPR.js","assets/OutputColorHighlightOID.glsl-aoJPKyQu.js","assets/Indices-C7UVLH6e.js","assets/BufferView-DpbAkaPZ.js","assets/renderState-CKc66y4x.js","assets/glsl-B5bJgrnA.js","assets/frustum-KkSlCHIy.js","assets/orientedBoundingBox-BYfKZK4t.js","assets/computeTranslationToOriginAndRotation-DyYeWWBZ.js","assets/InterleavedLayout-BPafPFid.js","assets/types-BKo2foNY.js","assets/ShaderBuilder-DuNE6Zp2.js"])))=>i.map(i=>d[i]);
import{lw as ze,bd as x,kW as W,bk as $e,nm as et,db as At,fk as Dt,kp as Gt,dU as V,kT as jt,BL as Bt,v7 as Ht,n4 as kt,BM as tt,bn as c,bo as H,bp as at,BN as Wt,BO as Ut,nl as Q,e0 as ot,nc as Fe,l3 as Ge,kR as Yt,qm as qt,BP as U,j as he,es as rt,n5 as ne,b5 as re,cP as Zt,cR as Xt,d2 as Jt,ah as Kt,mx as Qt,fT as ea,un as z,eY as ta,kt as aa,tD as oa,bF as ra,bP as ia,dR as be,dG as na,dO as je,dF as sa,kU as la,bf as ca}from"./index-Bc5nTF8z.js";import{a6 as R,i as me,d as pe,a7 as I,a as it,a8 as fe,a9 as nt,aa as st,ab as da,ac as k,ad as ua,ae as ha,af as ma,f as pa,ag as J,r as O,a2 as ae,D as A,E as D,ah as G,G as K,b as y,I as j,ai as fa,H as va,aj as ga,ak as lt,q as se,al as ct,o as dt,am as ut,g as xa,j as Ne,k as ve,s as ht,an as ba,ao as wa,u as ya,v as Be,ap as Ma,aq as _,ar as Oe,as as Ta,at as _a,c as ee,au as Sa,W as oe,av as Ca,M as za,aw as mt,ax as le,F as pt,L as ft,K as vt,ay as gt,J as xt,Q as $a,U as Fa,N as Na,O as Oa,P as Ia,R as La,V as Va,X as Ra,T as Ea,Y as Pa,x as m,A as Aa,az as we,aA as ye,a1 as Da,aB as Ga,B as ja,aC as Ba,a3 as Ha,aD as ka}from"./OutputColorHighlightOID.glsl-aoJPKyQu.js";import{t as Ce,Q as Ie}from"./InterleavedLayout-BPafPFid.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-DpbAkaPZ.js";import{r as Wa}from"./VertexBuffer-CliXVTDf.js";import{s as ge}from"./ShaderBuilder-DuNE6Zp2.js";import{T as Le,d as Ve,_ as Ua}from"./renderState-CKc66y4x.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return normal;
}`);break;default:ze(e.normalType);case 2:case 3:}}function Ya({code:a,uniforms:e},t){e.add(new R("dpDummy",()=>1)),a.add(i`vec3 dpAdd(vec3 hiA, vec3 loA, vec3 hiB, vec3 loB) {
vec3 hiD = hiA + hiB;
vec3 loD = loA + loB;
...
return color;
}`)}const Ue=W();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:o,instanced:r,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new da("model",l=>l.modelTransformation??Ge)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Yt(Ue,l.modelTransformation??Ge),Ue)))),r&&o&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;o&&(n.include(Ya,e),n.uniforms.add(new k("viewOriginHi",l=>ua(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new k("viewOriginLo",l=>ha(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
...
forwardTextureCoordinates();`),a.include(B,e),o.main.add(i`
        ...
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 4:case 5:case 6:case 7:case 10:A(t,e),a.include(D),a.include(G,e),a.include(K,e),a.include(co,e),o.include(j,e),a.include(va,e),ga(a),r.add("depth","float",{invariant:!0}),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),o.include(j,e),a.include(B,e),a.include(fa,e),o.main.add(i`
        discardBySlice(vpos);
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
}`),a.outputs.add("fragOcclusion","float"),e.uniforms.add(new y("normalMap",t=>t.normalTexture),new y("depthMap",t=>t.depthTexture),new O("projScale",t=>t.projScale),new y("rnm",t=>t.noiseTexture),new ct("rnmScale",(t,o)=>ne(Xe,o.camera.fullWidth/t.noiseTexture.descriptor.width,o.camera.fullHeight/t.noiseTexture.descriptor.height)),new O("intensity",t=>t.intensity),new wa("screenSize",t=>ne(Xe,t.camera.fullWidth,t.camera.fullHeight))).main.add(i`
...
}`))}function Ir(a,e){a.include(Oe),a.code.add(i`
...
}`)}function Ae(a){a.constants.add("ambientBoostFactor","float",_a)}function De(a){a.uniforms.add(new R("lightingGlobalFactor",e=>e.lighting.globalFactor))}function zt(a,e){const t=a.fragment,{pbrMode:o,spherical:r,hasColorTexture:s}=e;t.include(Ee,e),o!==0&&t.include(Pe,e),a.include(_o,e),t.include(Oe),t.include($o,e);const d=!(o===2&&!s);switch(d&&t.include(zo),t.code.add(i`
...
inputs.groundIrradianceToSurface = GROUND_REFLECTANCE * ambientLightIrradianceComponent + mainLightIrradianceComponent + fillLightsIrradianceComponent ;`),t.uniforms.add(new R("lightingSpecularStrength",n=>n.lighting.mainLight.specularStrength),new R("lightingEnvironmentStrength",n=>n.lighting.mainLight.environmentStrength)).code.add(i`vec3 horizonRingDir = inputs.RdotNG * groundNormal - reflectedView;
...
float occlusion;`),r&&o.uniforms.add(l===1?new y("texMetallicRoughness",u=>u.textureMetallicRoughness):new se("texMetallicRoughness",u=>u.textureMetallicRoughness)),d&&o.uniforms.add(l===1?new y("texOcclusion",u=>u.textureOcclusion):new se("texOcclusion",u=>u.textureOcclusion)),o.uniforms.add(l===1?new ee("mrrFactors",u=>u.mrrFactors):new Sa("mrrFactors",u=>u.mrrFactors)),o.code.add(i`
...
return texture(_shadowMap, uvzShadow);
}`)}let Eo=class extends me{constructor(e,t){super(e,"sampler2DShadow",0,(o,r)=>o.bindTexture(e,t(r)))}};function Nt(a,e){e.receiveShadows&&a.include(Lo),It(a,e)}function Ot(a,e){e.receiveShadows&&a.include(Vo),It(a,e)}function It(a,e){a.fragment.uniforms.add(new R("lightingGlobalFactor",r=>r.lighting.globalFactor));const{receiveShadows:t,spherical:o}=e;a.include(No,e),t&&Po(a),a.fragment.code.add(i`
  ...
  `)}function Po(a){a.include(Ro),a.fragment.uniforms.add(new Eo("shadowMap",({shadowMap:e})=>e.depthTexture)).code.add(i`float readShadowMap(const in vec3 _worldPos, float _linearDepth) {
...
metallicRoughnessUV = (metallicRoughnessTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):a.vertex.code.add(i`void forwardMetallicRoughnessUV(){}`)}function Lt(a){a.include(za),a.code.add(i`
  ...
  `)}function Vt(a,e){e.snowCover&&(a.uniforms.add(new R("snowCover",t=>t.snowCover)).code.add(i`float getSnow(vec3 normal, vec3 groundNormal) {
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(zt,a),r.include(Ee,a),e.include(B,a),r.include(j,a),e.include(xt,a),le(r,a),ue(r),Ae(r),De(r),r.uniforms.add(o.uniforms.get("localOrigin"),o.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new O("opacity",g=>g.opacity),new O("layerOpacity",g=>g.layerOpacity)),M&&r.uniforms.add(new y("tex",g=>g.texture)),e.include($t,a),r.include(Pe,a),r.include(Lt),r.include(Vt,a),te(r),r.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
